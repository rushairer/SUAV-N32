...
#define LED4_GPIO_CLK  RCC_AHB_PERIPH_GPIOA /* GPIO port clock */
#define LED4_GPIO_PIN  GPIO_PIN_4           /* GPIO connected to the SCL clock line */
#endif

/** Define macros that control IO **/
#define LED1_TOGGLE                           \
    {                                         \
        LED1_GPIO_PORT->POD ^= LED1_GPIO_PIN; \
    }
#define LED1_ON                              \
    {                                        \
        LED1_GPIO_PORT->PBC = LED1_GPIO_PIN; \
    } // BIT CLEAR  输出0
#define LED1_OFF                              \
    {                                         \
        LED1_GPIO_PORT->PBSC = LED1_GPIO_PIN; \
    }

#define LED2_TOGGLE                           \
    {                                         \
        LED2_GPIO_PORT->POD ^= LED2_GPIO_PIN; \
    }
#define LED2_ON                              \
    {                                        \
        LED2_GPIO_PORT->PBC = LED2_GPIO_PIN; \
    }
#define LED2_OFF                              \
    {                                         \
        LED2_GPIO_PORT->PBSC = LED2_GPIO_PIN; \
    }

#define LED3_TOGGLE                           \
    {                                         \
        LED3_GPIO_PORT->POD ^= LED3_GPIO_PIN; \
    }
#define LED3_ON                              \
    {                                        \
        LED3_GPIO_PORT->PBC = LED3_GPIO_PIN; \
    }
#define LED3_OFF                              \
    {                                         \
        LED3_GPIO_PORT->PBSC = LED3_GPIO_PIN; \
    }

#define LED4_TOGGLE                           \
    {                                         \
        LED4_GPIO_PORT->POD ^= LED4_GPIO_PIN; \
    }
#define LED4_ON                              \
    {                                        \
        LED4_GPIO_PORT->PBC = LED4_GPIO_PIN; \
    }
#define LED4_OFF                              \
    {                                         \
        LED4_GPIO_PORT->PBSC = LED4_GPIO_PIN; \
    }
