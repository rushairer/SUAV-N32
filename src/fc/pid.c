...
//  static float delta1[3] = {0.0f, 0.0f, 0.0f}, delta2[3] = {0.0f, 0.0f, 0.0f};	  
  ...
  const float _imaxPR    = 350.0f;				
	...
	pidconf.PRate[ROLL] = 0.12f;         pidconf.PRate[PITCH] = 0.12f;         pidconf.PRate[YAW] = 0.3f;	
	pidconf.IRate[ROLL] = 0.25f;         pidconf.IRate[PITCH] = 0.25f;         pidconf.IRate[YAW] = 0.6f;  
	pidconf.DRate[ROLL] = 0.0040f;       pidconf.DRate[PITCH] = 0.0040f;       pidconf.DRate[YAW] = 0.000f;
...
//    d = deltaSum * pidconf.DRate[axis];
    ...
    if(deltaT != 0) delta = -rate_d / deltaT;       
		else            delta = 0;
